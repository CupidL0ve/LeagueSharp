    ...
    class Program
    {
        ...
        private static void Drawing_OnDraw(EventArgs args)
        {
            ...
            if ((useQ && farmActive))
            {
                ...
                foreach (var minion in from minion in Minions where minion != null let targetQDam = Damage.GetSpellDamage(ObjectManager.Player, minion, SpellSlot.Q) where (minion.Health < targetQDam) select minion)
                {
